...
public class TestServletContext {
  ...
  public void testGetResourceAsStreamFromClasspath() {
    assertNotNull(context.getResourceAsStream("/WEB-INF/web.xml"), "resource was not found");
  }
  ...
  public void testGetResourceFromClasspath() throws Exception {
    assertNotNull(context.getResource("/WEB-INF/web.xml"), "resource was not found");
  }
  ...
  public void testGetResourceAsFileFromFileSystem() {
    ...
    assertNotNull(file, "resource was not found");
    assertTrue(file.exists(),"resource was not found");
  }
